...
class _CredentialsScreenState extends State<CredentialsScreen> {
                  ...
                  child: SingleChildScrollView(
                    child: Card(
                      ...
                      child: Padding(
                        ...
                        child: _buildPreviewWidget(document),
                      ),
                    ),
                  ),
                ),
  ...
  Widget _buildPreviewWidget(MedicalStaffDocument document) {
    ...
    if (isPdf) {
      return _buildPdfDocumentMock(document);
    } else {
  ...
  Widget _buildImageDocument(String fileUrl) {
    final publicUrl = 'https://hbnvbekhyyaclymabwwi.supabase.co/storage/v1/object/public/medical-documents/$fileUrl';
  ...
  Widget _buildPdfDocumentMock(MedicalStaffDocument document) {
    final doctorName = context.read<ProfileCubit>().doctor?.fullName ?? 'Doctor';
