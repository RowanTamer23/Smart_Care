        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text('Rowan Tamer', style: AppText.display(17)),
            ],
          ),
        ),
        Container(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Neurology • Video Consultation',
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text('Activity', style: AppText.display(16)),
          ...
          Row(
            ...
            children: [
              Text('8,400',
                  style: AppText.display(32, color: AppColors.primary)),
